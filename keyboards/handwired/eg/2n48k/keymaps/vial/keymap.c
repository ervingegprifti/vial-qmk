...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
        ...
        KC_LBRC,  KC_RBRC,  KC_BSLS,  KC_QUOT,  KC_TRNS,  KC_TRNS,
        KC_MINS,  KC_EQL,   KC_SLSH,  KC_TRNS,  KC_PGUP,  KC_TRNS,
        KC_TRNS,  KC_TRNS,  KC_MPLY,  KC_HOME,  KC_PGDN,  KC_END
    ),
	[2] = LAYOUT(
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [2] = { ENCODER_CCW_CW(KC_LEFT, KC_LEFT), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
};
#endif
